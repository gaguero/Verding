...
describe('HomePage', () => {
  ...
  it('has proper semantic structure', () => {
    ...
    const heroSection = screen.getByRole('heading', { name: /welcome to verding/i }).closest('section');
    const featuresSection = screen.getByRole('heading', { name: /key features/i }).closest('section');
